...
namespace Eventa.Infrastructure.Migrations
{
    ...
    [Migration("20251205094914_AddEventStatusAndComment")]
    partial class AddEventStatusAndComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventa.Domain.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eventa.Domain.Order", b =>
                {
                    ...
                    b.Property<bool>("IsQrTokenUsed")
                        .HasColumnType("tinyint(1)");

                    b.Property<DateTime?>("QrCodeUsingDateTime")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Eventa.Domain.Comment", b =>
                {
                    b.HasOne("Eventa.Domain.Order", "Order")
                        .WithOne("Comment")
                        .HasForeignKey("Eventa.Domain.Comment", "OrderId")
